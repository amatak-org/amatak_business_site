...
import Logo from "@/assets/svg/Amatak_logo2.png";
...
<template>
   <Teleport to="body">
      <header ref="headerRef" class="Header">
         <img :src="Logo" alt="Amatak.io" class="Logo" />
         <nav class="Navigation-Bar ">
            <menu class="Navlinks">
               ...
               <button type="button" class="Goto-Button">
                  Go to <a href="https://amatak.io/">Amatak.io</a>
               </button>
            </menu>
         </nav>
         <button
         ...
         <Transition name="sidebar">
            <aside v-if="sidebarIsOpen" class="Sidebar">
               <TransitionGroup @enter="onEnter" :css="false">
                  ...
                  <button :key="5" :data-index="4" class="Goto-Button">
                     Go to Amatak.io
                  </button>
               </TransitionGroup>
            </aside>
